...
# Main and Additional Simulation
...
ggsave(filename = paste0(figures_directory, "Figure 1", ".tiff"), 
       plot = plot1, device = 'tiff', dpi = 1200, 
       compression = 'lzw', width = 7, height = 9)
...
ggsave(filename = paste0(figures_directory, "Figure 2", ".tiff"),
       plot = plot2, 
       device ='tiff',
       dpi = 1200, 
       compression = 'lzw',
...
ggsave(filename = paste0(figures_directory, "Figure 3", ".tiff"),
       plot = plot3, 
       device='tiff', 
       dpi = 1200,
       compression = 'lzw',
...
ggsave(filename = paste0(figures_directory, "Figure 4", ".tiff"),
       plot = plot4,
       device='tiff', 
       dpi = 1200, 
       compression = 'lzw', 
...
ggsave(filename = paste0(figures_directory, "Figure 5", ".tiff"),
       plot = plot5,
       device='tiff',
       dpi = 1200,
       compression = 'lzw', 
...
ggsave(filename = paste0(figures_directory, "Figure 6", ".tiff"),
       plot = plot6,
       device='tiff',
       dpi = 1200,
       compression = 'lzw',
...
ggsave(filename = paste0(figures_directory, "Figure A1", ".tiff"),
       plot = plotA1, device='tiff',
...
ggsave(filename = paste0(figures_directory, "Figure A2", ".tiff"),
       plot = plotA2, 
       device='tiff', 
       dpi = 1200, 
       compression = 'lzw', 
...
ggsave(filename = paste0(figures_directory, "Figure A3", ".tiff"),
       plot = plotA3,
       device='tiff',
       dpi = 1200, 
       compression = 'lzw',
...
ggsave(filename = paste0(figures_directory, "Figure A4", ".tiff"), 
       plot = plotA4, 
       device='tiff', 
       dpi = 1200, 
       compression = 'lzw',
...
ggsave(filename = paste0(figures_directory, "Figure A5", ".tiff"),
       plot = plotA5, 
       device='tiff',
       dpi = 1200, 
       compression = 'lzw', 
...
ggsave(filename = paste0(figures_directory, "Figure A6", ".tiff"),
       plot = plotA6,
       device='tiff',
       dpi = 1200, 
       compression = 'lzw', 
...
ggsave(filename = paste0(figures_directory, "Figure A7", ".tiff"),
       plot = plotA7,
       device='tiff',
       dpi = 1200, 
       compression = 'lzw',
...
ggsave(filename = paste0(figures_directory, "Figure A8", ".tiff"),
       plot = plotA8,
       device='tiff',
       dpi = 1200, 
       compression = 'lzw', 
...
ggsave(filename = paste0(figures_directory, "Figure A9", ".tiff"),
       plot = plotA9,
       device='tiff',
       dpi = 1200, 
       compression = 'lzw', 

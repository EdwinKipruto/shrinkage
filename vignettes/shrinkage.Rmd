...
The RDS files are stored in `shrinkage` package for 15 and 30 covariates. 
...
output_directory1 <-  paste0(system.file("extradata", package = "shrinkage"),"/")
output_directory2 <- output_directory1

# Set directory where all Figures should be stored
figures_directory <-  paste0(system.file("plots", package = "shrinkage"),"/")
...
ggsave(filename = paste0(figures_directory, "Figure_1", ".pdf"), 
...
ggsave(filename = paste0(figures_directory, "Figure_2", ".pdf"),
       plot = plot2, 
       device ='pdf',
       dpi = 1200, 
       width = 7, 
...
ggsave(filename = paste0(figures_directory, "Figure_3", ".pdf"),
       plot = plot3, 
       device='pdf', 
       dpi = 1200,
       width = 6.5,
...
ggsave(filename = paste0(figures_directory, "Figure_4", ".pdf"),
       plot = plot4,
       device='pdf', 
       dpi = 1200, 
       width = 6.5, 
...
(betatrue <- shrinkage::beta_type(type = "a"))
...
ggsave(filename = paste0(figures_directory, "Figure_5", ".pdf"),
       plot = plot5,
       device='pdf',
       dpi = 1200,
       width = 8, 
...
ggsave(filename = paste0(figures_directory, "Figure_6", ".pdf"),
       plot = plot6,
       device='pdf',
       dpi = 1200,
       width = 8,
...
ggsave(filename = paste0(figures_directory, "Figure_A1", ".pdf"),
...
ggsave(filename = paste0(figures_directory, "Figure_A2", ".pdf"),
       plot = plotA2, 
       device='pdf', 
       dpi = 1200, 
       width = 7, height = 9)
...
ggsave(filename = paste0(figures_directory, "Figure_A3", ".pdf"),
       plot = plotA3,
       device='pdf',
       dpi = 1200, 
       width = 6.5, 
...
ggsave(filename = paste0(figures_directory, "Figure_A4", ".pdf"), 
       plot = plotA4, 
       device='pdf', 
       dpi = 1200, 
       width = 6.5,
...
ggsave(filename = paste0(figures_directory, "Figure_A5", ".pdf"),
       plot = plotA5, 
       device='pdf',
       dpi = 1200, 
       width = 10, 
...
ggsave(filename = paste0(figures_directory, "Figure_A6", ".pdf"),
       plot = plotA6,
       device='pdf',
       dpi = 1200, 
       width = 8, 
...
ggsave(filename = paste0(figures_directory, "Figure_A7", ".pdf"),
       plot = plotA7,
       device='pdf',
       dpi = 1200, 
       width = 8, 
...
ggsave(filename = paste0(figures_directory, "Figure_A8", ".pdf"),
       plot = plotA8,
       device='pdf',
       dpi = 1200, 
       width = 8, 
...
ggsave(filename = paste0(figures_directory, "Figure_A9", ".pdf"),
       plot = plotA9,
       device='pdf',
       dpi = 1200, 
       width = 8, 
